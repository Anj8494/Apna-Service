          ...
          <div className="card p-2">
            <div className="app-brand justify-content-center mt-5">
              <Link className="app-brand-link gap-2">
                ...
                <span className="app-brand-text demo text-heading fw-semibold">Apna Service</span>
              </Link>
            </div>
                ...
                <div className="mb-3">
                  <div className="form-password-toggle">
                    <div className="input-group input-group-merge">
                      ...
                      <span className="input-group-text cursor-pointer"><i className="mdi mdi-eye-off-outline"></i></span>
                    </div>
                  </div>
                </div>
